...
n=50000000#1000000 #50000000-1.2-2.0
B=0.01
alpha = 0.01
...
save_dict(final_times_R, 'edge_R_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(weights, 'edge_R_weight_'+str(int(100*a))+'_'+str(int(100*b)))
