...
times= np.power(weights, 1.0/a-1.0-b/a)#np.array((final_times[:,2]).T.tolist()[0])/1000
...
times= np.power(weights, 1.0/a-1.0) * (np.power(weights[0], 1.0/a-1.0-b/a)/np.power(weights[0], 1.0/a-1.0))#np.array((final_times[:,2]).T.tolist()[0])/1000
